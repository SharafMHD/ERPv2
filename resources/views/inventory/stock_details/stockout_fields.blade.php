...
<div class="form-group col-sm-6">
                ...
                {{-- {!! Form::select('expiry_date', array("class" => "form-control select2", "onchange" => "getitem_avialble_qty()" , "id"=>"expiry_date")) !!} --}}
                </div>
<!-- QTY Field -->
        <div class="form-group col-sm-6">
...
<div class="form-group col-lg-12">
    ...
    <div class="form-group col-lg-12">
        <div class="clearfix">
                <button type="button" onclick="AddNewItemStockout();" class="btn btn-circle green-jungle btn-block"><i class="fa fa-plus-circle"></i> @lang('fully.Add')</button> </div>
        </div>
<hr/>
<div class="form-group col-lg-12">
...
<div class="form-group col-sm-12">
    <div class="form-actions">
        ...
        <a id="btnsave" onclick="Stockout();" class="btn blue"><i class="fa fa-save"></i> @lang('fully.Save')</a>
